...
export type HankoCharacter = '正' | '誤' | '合' | '可' | '再' | '完'
...
const CHARACTER_STYLES: Record<HankoCharacter, {
  ...
  '正': {
    border: '#6B8F5E', // sage
    text:   '#4A6B3E', // sage-deep
    bg:     'transparent',
  },
  '誤': {
    border: '#E24B4A', // wrong red
    text:   '#501313', // wrong-text
    bg:     'transparent',
  },
  '合': {
    border: '#6B8F5E',
  ...
  '可': {
    border: '#D4B070', // drill-ring / amber
    text:   '#B8956A', // drill-accent
    bg:     'transparent',
  },
  '再': {
    border: '#E24B4A',
  ...
  '完': {
    border: '#C4728A', // sakura
    text:   '#9E4F68', // sakura-deep
    bg:     'transparent',
  },
}
